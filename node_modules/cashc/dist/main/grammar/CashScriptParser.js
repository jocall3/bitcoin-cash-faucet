...
exports.TypeNameContext = exports.NumberLiteralContext = exports.LiteralContext = exports.ModifierContext = exports.LiteralExpressionContext = exports.IdentifierContext = exports.NullaryOpContext = exports.ArrayContext = exports.BinaryOpContext = exports.UnaryOpContext = exports.UnaryIntrospectionOpContext = exports.TupleIndexOpContext = exports.InstantiationContext = exports.FunctionCallExpressionContext = exports.CastContext = exports.ParenthesisedContext = exports.ExpressionContext = exports.ExpressionListContext = exports.FunctionCallContext = exports.IfStatementContext = exports.RequireStatementContext = exports.TimeOpStatementContext = exports.AssignStatementContext = exports.TupleAssignmentContext = exports.VariableDefinitionContext = exports.StatementContext = exports.BlockContext = exports.ParameterContext = exports.ParameterListContext = exports.FunctionDefinitionContext = exports.ContractDefinitionContext = exports.VersionOperatorContext = exports.VersionConstraintContext = exports.PragmaValueContext = exports.PragmaNameContext = exports.PragmaDirectiveContext = exports.SourceFileContext = exports.CashScriptParser = void 0;
...
class CashScriptParser extends Parser_1.Parser {
    constructor(input) {
        super(input);
        this._interp = new ParserATNSimulator_1.ParserATNSimulator(CashScriptParser._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    static get _ATN() {
        if (!CashScriptParser.__ATN) {
            CashScriptParser.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(CashScriptParser._serializedATN));
        }
        return CashScriptParser.__ATN;
    }
}
exports.CashScriptParser = CashScriptParser;
...
class VariableDefinitionContext extends ParserRuleContext_1.ParserRuleContext {
    typeName() {
        return this.getRuleContext(0, TypeNameContext);
    }
    Identifier() { return this.getToken(CashScriptParser.Identifier, 0); }
...
class TupleAssignmentContext extends ParserRuleContext_1.ParserRuleContext {
    typeName(i) {
        if (i === undefined) {
...
exports.TupleAssignmentContext = TupleAssignmentContext;
...
class TimeOpStatementContext extends ParserRuleContext_1.ParserRuleContext {
...
exports.TimeOpStatementContext = TimeOpStatementContext;
class RequireStatementContext extends ParserRuleContext_1.ParserRuleContext {
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    constructor(parent, invokingState) {
...
exports.RequireStatementContext = RequireStatementContext;
...
class ParenthesisedContext extends ExpressionContext {
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    constructor(ctx) {
...
exports.ParenthesisedContext = ParenthesisedContext;
...
class InstantiationContext extends ExpressionContext {
    Identifier() { return this.getToken(CashScriptParser.Identifier, 0); }
    expressionList() {
        return this.getRuleContext(0, ExpressionListContext);
    }
...
class TupleIndexOpContext extends ExpressionContext {
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
exports.TupleIndexOpContext = TupleIndexOpContext;
class UnaryIntrospectionOpContext extends ExpressionContext {
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
exports.UnaryIntrospectionOpContext = UnaryIntrospectionOpContext;
...
class NullaryOpContext extends ExpressionContext {
...
exports.NullaryOpContext = NullaryOpContext;
