...
class OutputSourceCodeTraversal extends AstTraversal_js_1.default {
    constructor() {
        super(...arguments);
    ...
    visitHexLiteral(node) {
        this.addOutput(`0x${(0, libauth_1.binToHex)(node.value)}`);
        return node;
    }
}
exports.default = OutputSourceCodeTraversal;
